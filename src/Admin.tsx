      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          <div className="flex flex-col items-center">
            <Users className="h-24 w-24 mb-6 text-transparent bg-gradient-to-r from-purple-400 to-blue-500 bg-clip-text" />
        ...
        >
          <div className="flex flex-col items-center">
            <MessageCircle className="h-24 w-24 mb-6 text-transparent bg-gradient-to-r from-green-400 to-cyan-500 bg-clip-text" />
