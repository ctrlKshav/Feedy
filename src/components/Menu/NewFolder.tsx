...
const NewFolder = () => {
  ...
  return (
    <a
      className={`flex py-3 px-3 items-center gap-3 rounded-full hover:bg-gray-500/10 transition-colors duration-200 text-white text-sm mb-2 flex-shrink-0 border border-white/20 transition-opacity ${
        generating
